...
from variables import userdata_for_post_test_in_array as new_userdata
from variables import userdata_for_put_test_in_array as updated_userdata
from variables import username_for_array as username
...
def test_post_add_new_user_with_correct_data():
    response = requests.post(
        url="https://petstore.swagger.io/v2/user", json=new_userdata
    )
